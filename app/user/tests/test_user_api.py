...
class PublicUserApiTests(TestCase):
    """Test the public feature s of the user API."""
    ...
    def test_password_too_short_error(self):
        """Test an error occurs when user password is less than 5."""
        payload = {
            'email': 'test@example.com',
            'password': 'shot',
            'name': 'Test user'
    ...
    def  test_create_token_for_user(self):
        """Test genrates token for valide credentials."""
        user_details = {
            'name': 'Test user',
            'email': 'test@example.com',
    ...
    def test_create_token_with_blank_password(self):
        ...
        create_user(email='test@exmaple.com', password='testpass123')
        payload = {
            'email':'test@example.com',
            'password':''
        }
...
class PrivateUserApiTests(TestCase):
    ...
    def test_post_me_not_allowed(self):
        """Test POST is not allowed for the detail endpoint."""
